                ...
                <div class="col-lg-4">
                    <div class="bg-light p-3 border rounded mb-4">
                        ...
                        <ul class="list-unstyled pl-3 mb-0">
                            <li class="mb-2"><strong class="text-black">Published on:</strong> {{ $job->createdAt }}
                            </li>
                    ...
                    <div class="bg-light p-3 border rounded">
                        ...
                        <div class="px-3">
                            <a class="pt-3 pb-3 pr-3 pl-0"
                                href="https://www.facebook.com/sharer/sharer.php?u={{ route('single.jobs', $job->id) }}&quote={{ $job->job_title }}"><span
                                    class="icon-facebook"></span></a>
                            <a class="pt-3 pb-3 pr-3 pl-0"
                                href="https://twitter.com/intent/tweet?text={{ $job->job_title }}&url={{ route('single.jobs', $job->id) }}"><span
                                    class="icon-twitter"></span></a>
                            <a class="pt-3 pb-3 pr-3 pl-0"
                                href="https://www.linkedin.com/sharing/share-offsite/?url={{ route('single.jobs', $job->id) }}"><span
