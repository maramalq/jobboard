...
<section class="section-hero overlay inner-page bg-image" style="background-image: url({{ asset('assets/images/hero_1.jpg') }}); margin: -24px 0;" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
    ...
    <section class="py-5 bg-image overlay-primary fixed overlay" id="next-section" style="background-image: url({{ asset('assets/images/hero_1.jpg') }}); margin: 24px 0;">
      <div class="container">
