      ...
      <div class="col-md-12">
        ...
        <form method="post" action="{{ route('search.jobs') }}" class="search-jobs-form">
          ...
          <div class="row mb-5">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <select name="job_region" class="form-control form-control-lg selectpicker" data-style="btn-white btn-lg" data-width="100%" data-live-search="true"
                title="Select Region">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <select name="job_type" class="form-control form-control-lg selectpicker" data-style="btn-white btn-lg" data-width="100%" data-live-search="true"
